...
public class NoOpUserError extends Exception implements NoBugError {
     ...
     * @param arguments Arguments for the short message.
     */
    ...
    /**
     * Convenience constructor for messages with no arguments and cause.  @param cause the cause
     *
    ...
    /**
     * Instantiates a new No op user error.
     *
     * @param code      the code
    ...
    /**
     * Convenience constructor for messages with no arguments.  @param code the code
     *
     * @param code the code
     */
    ...
    /**
     * Convenience constructor for messages with exactly one argument.  @param code the code
     *
     * @param code      the code
    ...
    /**
     * Convenience constructor for messages with exactly two arguments.  @param code the code
     *
     * @param code      the code
     * @param argument1 the argument 1
