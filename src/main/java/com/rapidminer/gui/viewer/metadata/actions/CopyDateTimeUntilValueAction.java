 ...
 * @author Marco Boeck
 */
public class CopyDateTimeUntilValueAction extends ResourceAction {

	private static final long serialVersionUID = 1L;

    /**
     * Creates a new {@link CopyDateTimeUntilValueAction} instance.
     */
    public CopyDateTimeUntilValueAction() {
		super(true, "meta_data_stats.copy_date_time_until");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		DateTimeAttributeStatisticsModel model = (DateTimeAttributeStatisticsModel) asp.getModel();
		Tools.copyStringToClipboard(model.getUntil());
	}
