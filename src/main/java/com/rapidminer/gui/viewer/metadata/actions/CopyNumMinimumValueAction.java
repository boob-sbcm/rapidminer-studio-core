 ...
 * @author Marco Boeck
 */
public class CopyNumMinimumValueAction extends ResourceAction {

	private static final long serialVersionUID = 1L;

    /**
     * Creates a new {@link CopyNumMinimumValueAction} instance.
     */
    public CopyNumMinimumValueAction() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Tools.copyStringToClipboard(String.valueOf(model.getMinimum()));
	}
