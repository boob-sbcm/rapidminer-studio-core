...
public class FormattedXYDifferenceRenderer extends XYDifferenceRenderer implements FormattedRenderer {
	...
	/**
	 * The Difference plotter can only plot one series at a time, and that series has index 0. One
	 * value source can contain multiple series. trueSeriesIdx stores which series in the value
	 * source this FormattedXYDifferenceRenderer represents.
	 * 
	 */
