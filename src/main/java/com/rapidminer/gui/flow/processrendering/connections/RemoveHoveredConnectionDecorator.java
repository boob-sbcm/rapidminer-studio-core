 ...
 * @since 7.1.0
 */
public final class RemoveHoveredConnectionDecorator implements ProcessDrawDecorator, ProcessEventDecorator {
	...
	private void draw(final ExecutionUnit process, final Graphics2D g2, final boolean printing) {
		...
		if (source == rendererModel.getSelectedConnectionSource() || rendererModel.getHoveringPort() != null
