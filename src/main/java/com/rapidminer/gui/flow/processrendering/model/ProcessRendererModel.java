...
public final class ProcessRendererModel {
    ...
    /**
     * Instantiates a new Process renderer model.
     */
     ...
     * @param isNew   indicates if the process should be handled as a new process
     * @param open    whether the process was newly opened e.g. from a file
     * @since 7.5
     */
     ...
     * @see #setToStep(int) #setToStep(int)#setToStep(int)
     * @since 7.5
     */
     ...
     *
     * @param index the index of the process to return. If index is invalid, throws
     ...
     *
     * @param process the process for which the index should be retrieved
     ...
     *
     * @param processes the new processes to display
     */
     ...
     *
     * @param displayedChain the new operator chain to display
     */
     ...
     *
     * @param displayedChain the new chain to display
     * @since 7.5
     */
     ...
     *
     * @param selectedOperator this operator is added to the list of currently selected operators
     */
     ...
     *
     * @param selectedOperator this operator is removed from the list of currently selected operators
     */
     ...
     *
     * @param selectedOperators these operators are added to the list of currently selected operators
     */
     ...
     *
     * @param draggedOperators these operators are set as the currently dragged operators
     */
     ...
     *
     * @param snapToGrid whether operators should snap to a grid or not
     */
     ...
     *
     * @param dragStarted {@code true} if dragging is in progress; {@code false} otherwise
     */
     ...
     * not supported.
     *
     * @param dropTargetSet {@code true} if a valid drop target was set; {@code false} otherwise
     */
     ...
     *
     * @param operatorSourceHovered {@code true} if a an operator source (tree, WoC, ...) is hovered; {@code false}            otherwise
     */
     ...
     *
     * @param currentMousePosition the position or {@code null} if it is not over the renderer
     */
     ...
     * import is accepted.
     *
     * @param importDragged {@code true} if the import would be accepted; {@code false} otherwise
     */
     ...
     *
     * @param selectedConnectionSource the connection source port or {@code null}
     */
     ...
     *
     * @param connectingPortSource the source port of the connection currently being created or {@code null}
     */
     ...
     *
     * @param hoveringProcessIndex the hovered process index
     */
     ...
     *
     * @param hoveringOperator the operator under the mouse or {@code null}
     */
     ...
     *
     * @param hoveringConnectionSource the output port of the connection under the mouse or {@code null}
     */
     ...
     *
     * @param hoveringPort the port under the mouse or {@code null}
     */
     ...
     *
     * @param selectionRectangle the selection rectangle or {@code null}
     */
     ...
     *
     * @param process the size of this process is returned
     ...
     *
     * @param process the process for which the width should be returned
     ...
     * nothing.
     *
     * @param zoomFactor factor in {@link #ZOOM_FACTORS}
     */
     ...
     *
     * @param process the process for which the height should be set
     ...
     *
     * @param process the process for which the height should be returned
     ...
     *
     * @param process the size of this process is stored
     * @param size    the size of the specified process
     */
     ...
     * @return the rectangle. Can return {@code null} but only if the operator has not been added to         the {@link com.rapidminer.gui.flow.processrendering.view.ProcessRendererView
     * ProcessRendererView}.
     */
     ...
     *
     * @param process the process for which to remove the background image
     */
     ...
     *
     * @param op     the operator in question
     * @param number the number of ports or {@code null}
     ...
     *
     * @param op   the operator for which the rectangle should be set
     * @param rect the rectangle representing position and size of operator
     */
     ...
     *
     * @param port    the port in question
     * @param spacing the additional spacing before the port
     */
     ...
     *
     * @param operatorChain The operator.
     ...
     *
     * @param mousePositionRelativeToProcess the point or {@code null}
     */
     ...
     * @param index  the (new) process index
     * @since 7.5
     */
     ...
     *
     * @param operator the moved operator
     */
     ...
     *
     * @param operators a collection of moved operators
     */
     ...
     *
     * @param operators a collection of selected operators
     */
     ...
     *
     * @param operators a collection of operators which had their ports changed
     */
     ...
     *
     * @param anno the moved annotation
     */
     ...
     *
     * @param annotations the moved annotations
     */
     ...
     *
     * @param anno the selected annotation
     */
     ...
     * repaint.
     *
     * @param anno the changed annotation, can be {@code null}
     */
