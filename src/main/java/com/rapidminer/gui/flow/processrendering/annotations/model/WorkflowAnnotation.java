...
public abstract class WorkflowAnnotation {
     ...
     *
     * @param comment the comment, never {@code null}
     */
     ...
     *
     * @return {@code true} if the user has manually resized this annotation; {@code false}         otherwise
     */
     ...
     *
     * @return {@code true} if the user has manually colored this annotation; {@code false}         otherwise
     */
     ...
     *
     * @param overflowing the overflowing
     * @return {@code true} if it is; {@code false} otherwise
     */
     ...
     *
     * @param attachedTo the operator the annotation should be attached to
     ...
     *
     * @param process the process the annotation should be attached to
     * @return the annotation instance, never {@code null}
     */
