...
public interface LogModel extends Observable<List<LogEntry>> {
     ...
     *
     * @return the icon displayed next to the name in the list of open logs. Can be         <code>null</code>!
     */
    public Icon getIcon();
     ...
     * </p>
     *
     * @param progress used to indicate the progress of the update by calling            {@link ProgressListener#setCompleted(int)}.            <p>            Valid progress values range from <code>0 - 100</code>.            </p>
     * @throws LogUpdateException if the update fails
     */
