...
/**
 * This is the abstract model of a {@link LogMode#PUSH} log in the {@link LogViewer}.
 *
 * @author Marco Boeck
 */
public abstract class AbstractPushLogModel extends AbstractLogModel {
     ...
     */
    public AbstractPushLogModel(Icon modelIcon, String modelName, boolean isClosable) {
		super(modelIcon, modelName, LogMode.PUSH, isClosable);
	}
	...
	@Override
	public void updateEntries(ProgressListener progress) {
		// not required for PUSH logs
		if (getLogMode() == LogMode.PUSH) {
			return;
		}
	}
}
