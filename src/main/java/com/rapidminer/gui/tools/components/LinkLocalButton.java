...
/**
 * Can be used as a label that triggers a local action event on every link activation click. To use
 * a link button which opens a URL in the web browser, use {@link LinkRemoteButton} instead. The
 * local and the remote link button may use different color schemes or other indicates so the user
 * knows what is about to happen before he clicks the link.
 * <p>
