...
/**
 * A BackgroundExecution can either be a process ({@link ProcessBackgroundExecution}) or a operator
 * ({@link OperatorBackgroundExecution}) which can be executed in the background.
 * <p>
