...
public interface Expression {
     ...
     * @throws ExpressionException if the evaluation failed. The ExpressionException can contain a             {@link ExpressionParsingException} as cause. See the java doc of             {@link ExpressionParsingException} for different marker subclasses of special             error cases.
     */
     ...
     * expression type using {@link #getExpressionType()} before calling this method.
     *
     * @return the date result of the evaluation if the expression is a date expression, can return         {@code null}
     * @throws ExpressionException if the evaluation failed. The ExpressionException can contain a             {@link ExpressionParsingException} as cause. see the java doc of             {@link ExpressionParsingException} for different marker subclasses of special             error cases.
     */
