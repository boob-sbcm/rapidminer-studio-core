...
public interface ExpressionParser {
     ...
     * @throws ExpressionException if the syntax check failed. The ExpressionException can contain a             {@link ExpressionParsingException} as cause. see the java doc of             {@link ExpressionParsingException} for different marker subclasses of special             error cases.
     */
     ...
     * @throws ExpressionException if the parsing failed. The ExpressionException can contain a             {@link ExpressionParsingException} as cause. see the java doc of             {@link ExpressionParsingException} for different marker subclasses of special             error cases.
     */
