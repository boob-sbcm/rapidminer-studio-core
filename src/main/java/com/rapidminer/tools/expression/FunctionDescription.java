...
public class FunctionDescription {
    ...
    /**
     * The constant UNFIXED_NUMBER_OF_ARGUMENTS.
     */
     ...
     * parameters.
     *
     * @param i18nKey           the key determining the function description
     * @param numberOfArguments the number of arguments the function takes, or -1 if this is not a fixed number
     * @param returnType        the {@link Ontology#ATTRIBUTE_VALUE_TYPE} of the result of the function
     * @since 6.5.0
     */
     ...
     *
     * @return the function name with parameters
     */
