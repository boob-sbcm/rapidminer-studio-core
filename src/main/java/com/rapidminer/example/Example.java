...
public class Example implements Serializable, Map<String, Object> {
     ...
     *
     * @param data             the data
     * @param parentExampleSet the parent example set
     */
    ...
    /**
     * Returns the data row which backs up the example in the example table.  @return the data row
     *
     * @return the data row
     */
    ...
    /**
     * Delivers the attributes.  @return the attributes
     *
     ...
     * @param quoteNominal        the quote nominal
     * @return the attributes as sparse string
     */
