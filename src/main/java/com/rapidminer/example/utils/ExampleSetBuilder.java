...
public abstract class ExampleSetBuilder {
     ...
     *
     * @param attributes the {@link Attribute}s that the {@link ExampleSet} should contain, can be            {@code null}
     */
     ...
     *
     * @param specialAttributes map from attributes to their role names
     * @return the builder
     */
     ...
     * builder.
     *
     * @param attribute the attribute that has a special role, must not be {@code null}
     * @param role      the role name for the attribute
     * @return the builder
     */
     ...
     * are added.
     *
     * @param numberOfRows the expected number of rows
     * @return the builder
     */
     ...
     *
     * @param dataRow the data row to add
     * @return the builder
     ...
     *
     * @param reader a {@link DataRowReader} providing rows for the data table
     * @return the builder
     */
     ...
     *
     * @param numberOfRows the number of blank rows to create
     * @return the builder
     */
     ...
     *
     * @param attribute   the attribute for which the column should be filled by valueForRow
     * @param valueForRow the function to fill the column associated with the attribute
     * @return the builder
     */
     ...
     *
     * @param management the data management optimization to use
     * @return the builder
     */
