...
public interface ExampleTable extends Serializable {
    ...
    /**
     * Returns the number of examples.  @return the int
     *
     * @return the int
     */
    public int size();
    ...
    /**
     * Returns a new array containing all {@link Attribute}s.  @return the attribute [ ]
     *
     ...
     * @see ExampleTable#getNumberOfAttributes() ExampleTable#getNumberOfAttributes()ExampleTable#getNumberOfAttributes().
     */
     ...
     *
     * @param newSpecialAttributes the new special attributes
     * @return the example set
     */
/*
    ...
    /**
     * Dumps the complete data as string.  @return the string
     *
     * @return the string
     */
