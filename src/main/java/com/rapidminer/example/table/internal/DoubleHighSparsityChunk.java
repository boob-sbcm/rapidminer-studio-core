...
/**
 * A small sparse chunk that stores double values with high sparsity.
 *
 * @author Jan Czogalla
 * @since 7.3.1
 */
final class DoubleHighSparsityChunk extends AbstractHighSparsityChunk implements DoubleSparseChunk {
