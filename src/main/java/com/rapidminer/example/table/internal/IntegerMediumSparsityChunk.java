...
/**
 * A grand sparse chunk that stores integer values of medium sparsity.
 *
 * @author Jan Czogalla
 * @since 7.3.1
 */
final class IntegerMediumSparsityChunk extends AbstractMediumSparsityChunk implements IntegerSparseChunk {
	...
	protected double getMaximalDensity(int row) {
		return AutoColumnUtils.THRESHOLD_INTEGER_MEDIUM_SPARSITY_MAXIMAL_DENSITY;
	}
