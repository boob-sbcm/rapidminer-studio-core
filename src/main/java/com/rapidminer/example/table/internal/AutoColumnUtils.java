...
final class AutoColumnUtils {
    ...
    static class DensityResult {
        ...
        /**
         * Instantiates a new Density result.
         *
         * @param density           the density
         * @param mostFrequentValue the most frequent value
         */
     ...
     * @param index   the index until which dest should be the same as source
     * @param srcOff  from where on to copy the end of src
     * @param destOff from where on to paste the end of src into dest
     * @param length  the length to which src is filled
     */
