...
/**
 * Dense {@link DoubleAutoChunk} for double value data in a {@link DoubleAutoColumn}.
 *
 * @author Gisa Schaefer
 * @since 7.3.1
 */
final class DoubleAutoDenseChunk extends DoubleAutoChunk {
	...
	private void checkSparse() {
		...
		if (result.density < thresholdDensity) {
			...
			DoubleAutoChunk sparse = new DoubleAutoSparseChunk(chunks, id, defaultValue, management);
