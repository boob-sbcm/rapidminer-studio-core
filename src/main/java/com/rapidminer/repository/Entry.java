...
public interface Entry {
    ...
    /**
     * Returns the name, the last part of the location.  @return the name
     *
     * @return the name
     */
    ...
    /**
     * Returns a string describing the type: "folder", "data", "blob", or "process".  @return the type
     *
     * @return the type
     */
    ...
    /**
     * Returns true if this entry cannot be written to.  @return the boolean
     *
     * @return the boolean
     */
    ...
    /**
     * Returns the folder containing this entry.  @return the containing folder
     *
    ...
    /**
     * Returns custom actions to be displayed in this entry's popup menu.  @return the custom actions
     *
