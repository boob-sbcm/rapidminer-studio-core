...
public enum CustomRepositoryRegistry {
    ...
    /**
     * Instance custom repository registry.
     */
    INSTANCE;
     ...
     * @throws RepositoryException thrown if a factory for the {@link Repository} class or XML tag is already             registered
     * @since 6.5
     */
     ...
     * @return the {@link CustomRepositoryFactory} for the provided XML tag or {@code null} if no         factory is available for the provided tag
     * @since 6.5
     */
