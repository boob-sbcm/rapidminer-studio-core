 ...
 *
 * @param <T> The type the user data will be attached to. An instance of this type will be supplied            to the copy method.
...
public interface UserData<T> {
     ...
     *
     * @param newParent the reference to the new (duplicated) parent object
