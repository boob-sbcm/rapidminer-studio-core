...
public class LiftParetoChart extends ResultObjectAdapter implements Renderable {
    ...
    /**
     * Instantiates a new Lift pareto chart.
     *
     * @param liftChartData        the lift chart data
     * @param targetValue          the target value
     * @param showBarLabels        the show bar labels
     * @param showCumulativeLabels the show cumulative labels
     * @param rotateLabels         the rotate labels
     */
    ...
    /**
     * Gets lift chart data.
     *
     * @return the lift chart data
     */
    ...
    /**
     * Show cumulative labels boolean.
     *
     * @return the boolean
     */
