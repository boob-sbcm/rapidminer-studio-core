...
public final class XlsxUtilities {
    ...
    /**
     * The constant TAG_CELL_REFERENCE.
     *
     ...
     * for the first row).
     *
     * @param cellReference the cell reference string that starts with letters and ends with digits (e.g.            'AA123')
     * @return the pair with column number as first (starts with {@code 0}) and row number as second         content (starts with {@code 0}, is {@link XlsxCellCoordinates#NO_ROW_NUMBER} in case         no row number is defined)
     */
     ...
     *
     * @param reader the {@link XMLStreamReader} to use
