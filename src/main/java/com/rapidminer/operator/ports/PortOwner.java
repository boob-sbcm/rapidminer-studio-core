...
public interface PortOwner {
    ...
    /**
     * Returns the operator to which these ports are attached.  @return the operator
     *
     * @return the operator
     */
    ...
    /**
     * Returns a human readable name used for error messages and gui.  @return the name
     *
     * @return the name
     */
    ...
    /**
     * Two ports can connect iff they belong to the same connection context.  @return the connection context
     *
