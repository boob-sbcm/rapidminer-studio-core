...
public interface InputPort extends Port {
    ...
    /**
     * Does the same as {@link #receive(Object)} but only with meta data.  @param metaData the meta data
     *
    ...
    /**
     * Returns the output port to which this input port is connected.  @return the source
     *
     * @return the source
     */
    ...
    /**
     * Adds a precondition to this input port.  @param precondition the precondition
     *
    ...
    /**
     * Returns a collection (view) of all preconditions assigned to this InputPort.  @return the all preconditions
     *
     * @return the all preconditions
     */
    ...
    /**
     * Returns true if the given input is compatible with the preconditions.  @param input the input
     *
    ...
    /**
     * Returns a human readable representation of the preconditions.  @return the precondition description
     *
