...
public class FPTreeNode {
    ...
    /**
     * Instantiates a new Fp tree node.
     */
    public FPTreeNode() {
     ...
     * @param headerTable gives the headertable for finding other nodes of an item
     ...
     * @param value          the frequency is increased by this value
     */
