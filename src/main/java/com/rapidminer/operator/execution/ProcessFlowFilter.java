...
public interface ProcessFlowFilter {
     ...
     * @param input            a list of all input data for the next operator. The order of the data is in the            same order as the ports but ports which have no input data or an not connected            will be skipped in this list. Can be empty but never {@code null}
     * @throws OperatorException if something goes wrong during filter application. Will stop the process with the             thrown exception.
     */
     ...
     * @param output           a list of all output data from the previous operator. The order of the data is in            the same order as the ports but ports which have no output data or an not            connected will be skipped in this list. Can be empty but never {@code null}
     * @throws OperatorException if something goes wrong during filter application. Will stop the process with the             thrown exception.
     */
