...
public interface ProcessSetupError {
    ...
    /**
     * Returns the human readable, formatted message.  @return the message
     *
     * @return the message
     */
    ...
    /**
     * If possible, return a list of fixes for the error.  @return the quick fixes
     *
    ...
    /**
     * Returns the severity of the error.  @return the severity
     *
     * @return the severity
     */
