...
public class GridSearchParameterOptimizationOperator extends ParameterOptimizationOperator {
    ...
    /**
     * Instantiates a new Grid search parameter optimization operator.
     *
    ...
    /**
     * Computes the performance for the current parameter values.  @return the performance vector
     *
     * @return the performance vector
