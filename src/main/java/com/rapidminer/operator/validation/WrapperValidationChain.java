...
public abstract class WrapperValidationChain extends OperatorChain implements CapabilityProvider {
    ...
    /**
     * Applies the method.  @param methodTrainingSet the method training set
     *
     * @param methodTrainingSet the method training set
    ...
    /**
     * Applies the learner.  @param trainingSet the training set
     *
    ...
    /**
     * Applies the applier and evaluator.  @param testSet the test set
     *
