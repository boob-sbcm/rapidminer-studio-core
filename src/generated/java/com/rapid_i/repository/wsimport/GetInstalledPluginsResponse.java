...
/**
 * <p>Java class for getInstalledPluginsResponse complex type.
 * <p>
...
public class GetInstalledPluginsResponse {
    ...
    protected List<PluginInfo> _return;
     ...
     * @return the return
     */
    public List<PluginInfo> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PluginInfo>();
        }
        return this._return;
    }
